...
public class TabTebakHurufBisindoGuru extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_tab_tebak_huruf_bisindo_guru,
                container, false);

        recyclerView = view.findViewById(R.id.rvTbkGuru);
    ...
    private void loadData() {
        ...
        Call<List<Tebak>> tebakHuruf = api.getTebakHuruf("1");
