...
public class TabTebakKataBisindoGuru extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_tab_tebak_kata_bisindo_guru, container, false);

        recyclerView = view.findViewById(R.id.rvTbkKataGuru);
    ...
    private void loadData() {
        ...
        Call<List<Tebak>> tebakHuruf = api.getTebakKata("1");
