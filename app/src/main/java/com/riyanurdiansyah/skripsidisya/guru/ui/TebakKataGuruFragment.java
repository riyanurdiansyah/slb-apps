...
import com.riyanurdiansyah.skripsidisya.guru.adapter.TabAdapterTebakKata;
...
public class TebakKataGuruFragment extends Fragment {
    View view;
    FloatingActionButton fab_tambah;
    TabLayout tabLayout;
    ViewPager viewPager;
    TabAdapterTebakKata tabAdapter;
    Dialog dialog;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_tebak_kata_guru, container, false);
        dialog = new Dialog(getActivity());
        loadingDialog = new LoadingDialog(getActivity());

        fab_tambah = view.findViewById(R.id.fabTbkKataGuru);
        viewPager = view.findViewById(R.id.pagerTebakKataGuru);
        tabLayout = view.findViewById(R.id.tab_layout_tbk_kata);
        ...
        tabAdapter = new TabAdapterTebakKata(getActivity().getSupportFragmentManager(), tabLayout.getTabCount());
        ...
        fab_tambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                tv_judul = dialog.findViewById(R.id.tvJudul);

                tv_judul.setText("TAMBAH TEBAK KATA");
    ...
    private void uploadData() {
        ...
        Call<AllResponse> tambah = api.tambahTbkKata(
                partImage,
        ...
        tambah.enqueue(new Callback<AllResponse>() {
            ...
            public void onResponse(Call<AllResponse> call, Response<AllResponse> response) {
                ...
                loadFragment(new TebakHurufGuruFragment());
            }
            @EverythingIsNonNull
            @Override
