...
public class TebakKataAdapter extends RecyclerView.Adapter<TebakKataAdapter.ViewHolder> {

    List<Tebak> tebak;
    Context context;

    public TebakKataAdapter(List<Tebak> tebak, Context context) {
        this.tebak = tebak;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        Glide.with(context)
                .load(ApiClient.MATERI_TEBAK_KATA + tebak.get(position).getSoal())
                .into(holder.iv_foto);
            ...
            public boolean onLongClick(View v) {
                ...
                btn_ya.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Call<AllResponse> hapus = apiInterface.deleteTbkKata(id);
